    ...
    return (
      <div className="flex items-start justify-between gap-4 py-2">
        <div className="flex flex-col gap-1">
          <label htmlFor={toggleId} className="font-bold text-gray-900 leading-tight cursor-pointer">{label}</label>
          {description && (
            <span id={descId} className="text-sm text-gray-500 leading-snug">
              {description}
            </span>
          )}
        </div>
