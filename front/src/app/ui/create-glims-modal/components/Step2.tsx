...
export default function Step2({
  ...
  return (
    <div className="flex flex-col flex-1 gap-6">
      {/* TABS */}
      <div className="flex gap-4 mb-2" role="tablist" aria-label="Méthode d'invitation">
        <button
          type="button"
          role="tab"
        ...
        <>
          <div className="relative">
            ...
            <input
              ...
              aria-label="Ajouter des personnes par email"
          ...
          {/* AVATARS */}
          <div className="flex items-center gap-[-8px]" role="group" aria-label="Liste des membres à inviter">
            ...
            <button
              ...
              aria-label="Voir ou modifier la liste détaillée des membres"
      ...
      <div className="h-px bg-gray-100 my-2" role="separator" aria-hidden="true" />

      {/* REACTIONS TOGGLE */}
      <div className="space-y-4">
        <div className="flex items-center gap-3">
          <label className="relative inline-flex items-center cursor-pointer" htmlFor="reactions-creation-toggle">
            <input
              id="reactions-creation-toggle"
              type="checkbox"
        ...
        {reactionsEnabled && (
          <div className="flex flex-wrap gap-3" role="group" aria-label="Sélection des réactions">
            {reactions.map((emoji, index) => (
              <button
                ...
                className="relative group w-12 h-12 flex items-center justify-center border border-dashed border-gray-300 rounded-lg text-2xl bg-white cursor-pointer hover:border-gray-400">
            ...
            <button
              ...
              className="w-12 h-12 flex items-center justify-center bg-gray-50 border border-dashed border-gray-200 rounded-lg text-gray-400 hover:text-gray-600 transition cursor-pointer">
            ...
            <div className="ml-auto flex items-center justify-center">
              <button 
                ...
                className="w-8 h-8 rounded-full text-slate-900 transition bg-amber-200 hover:bg-amber-300 cursor-pointer shadow-sm flex items-center justify-center">
                <Crown
                  size={16}
                  fill="currentColor"
                  aria-hidden="true"
