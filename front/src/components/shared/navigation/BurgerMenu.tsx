    ...
    <>
      <div className="flex justify-center items-center">
        ...
        <button
          ...
          className="p-1 mr-1 rounded-lg border border-transparent cursor-pointer text-slate-900 active:text-orange-500 active:bg-orange-100 active:border-orange-200 transition focus:outline-none focus:ring-2 focus:ring-orange-200"
        ...
        <Modal
          ...
          position="custom"
          className="fixed inset-y-0 left-0 h-full w-4/5 sm:w-1/2 max-w-xs animate-in slide-in-from-left duration-300 shadow-2xl z-[60]"
